...
client.on("chat", (channel, userstate, message, self) => {
  ...
  if (
    ...
    commandLastUsed + COMMAND_COOLDOWN
  ) {
    if (
      (userstate.badges != null &&
        userstate.badges.hasOwnProperty("broadcaster") &&
...
// if there are any errors display them to the console.
obs.on("error", (err) => {
